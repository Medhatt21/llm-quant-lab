    ...
    def get_catcher(self, first_block_input):
        class Catcher(nn.Module):
            ...
            def __getattr__(self, name):
                # Delegate any attribute the wrapped block exposes (e.g.
                # transformers>=5.1 reads `decoder_layer.attention_type` off the
                # layer object before calling it) to the wrapped module, so the
                # Catcher is a transparent stand-in during input capture.
                try:
